            ...
            return Obx(() => Row(
                  ...
                  children: <Widget>[
                    ButtonWidget(
                      ...
                      color: dc.changeView("light").last,
                      boxColor: dc.changeView("light").first,
                    ...
                    ButtonWidget(
                      ...
                      color:dc.changeView("cooler").last,
                      boxColor: dc.changeView("cooler").first,
                      text: dc.coolerValue.value ? "Close" : "Open",
                      textColor: dc.changeView("cooler").last,
                    ),
                    ButtonWidget(
                      ...
                      size: size,
                      icon: GlobalVal.door,
                      color: dc.changeView("door").last,
                      boxColor: dc.changeView("door").first,
                      text: dc.doorValue.value ? "Close" : "Open",
                      textColor: dc.changeView("door").last,
                    ),
